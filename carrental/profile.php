...
<!-- /Header --> 
<!--Page Header-->
<section class="page-header profile_page" style="background-image: url('assets/images/profile-banner.jpg');">
  <div class="container">
    <h1>Your Profile</h1>
  </div>
...
<section class="user_profile inner_pages">
  <div class="container">
    <div class="user_profile_info premium-card" style="display: flex; align-items: center; gap: 30px; margin-top: -50px; position: relative; z-index: 10;">
      <div class="upload_user_logo" style="width: 100px; height: 100px; border-radius: 50%; overflow: hidden; border: 5px solid #fff; box-shadow: 0 5px 15px rgba(0,0,0,0.1);"> 
        <img src="assets/images/dealer-logo.jpg" alt="image" style="width: 100%; height: 100%; object-fit: cover;">
      </div>

      <div class="dealer_info">
        <h5 style="font-size: 24px; margin-bottom: 5px;"><?php echo htmlentities($result->FullName);?></h5>
        <p style="margin: 0; color: #777;"><?php echo htmlentities($result->Address);?>, <?php echo htmlentities($result->City);?>&nbsp;<?php echo htmlentities($result->Country);?></p>
      </div>
    </div>
          ...
          <form  method="post">
           <div class="form-group">
            ...
            <div class="form-group">
              ...
              <input class="form-control"  id="country" name="country" value="<?php echo htmlentities($result->City);?>" type="text">
            </div>
            <div class="form-group">
