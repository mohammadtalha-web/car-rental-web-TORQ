...
<!--Page Header-->
<section class="page-header listing_page" style="background-image: url('assets/images/listing-banner.jpg');">
  <div class="container">
...
<p><span><?php echo htmlentities($cnt);?> Listings</span></p>
          ...
          <div class="layout-toggler">
              <button class="btn-layout active" id="grid-view-btn" onclick="toggleLayout('grid')"><i class="fa fa-th"></i></button>
              <button class="btn-layout" id="list-view-btn" onclick="toggleLayout('list')"><i class="fa fa-list"></i></button>
          </div>
</div>
      ...
      <aside class="col-md-3 col-md-pull-9">
        <div class="sidebar_widget">
          <div class="widget_heading">
            <h5 style="font-family: 'Syne', sans-serif; font-weight: 800; border-bottom: 2px solid var(--premium-primary); padding-bottom: 10px; margin-bottom: 20px;">
                <i class="fa fa-filter" aria-hidden="true" style="color: var(--premium-primary); margin-right: 10px;"></i> Filter Cars
            </h5>
          </div>
